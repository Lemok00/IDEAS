...
if __name__ == "__main__":
    ...
    while i < args.num + 1:
        with torch.no_grad():
            ...
            generating_times.append(time.time()-start_time)
            ...
            extracting_times.append(time.time()-start_time)
    ...
    generating_time = np.array(generating_times).mean()
    extracting_time = np.array(extracting_times).mean()

    print(f'generating time: {generating_time}')
    print(f'extracting time: {extracting_time}')
